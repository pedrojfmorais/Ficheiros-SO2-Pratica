...
LRESULT CALLBACK TrataEventos(HWND hWnd, UINT messg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (messg)
	{
	case WM_CREATE: //https://docs.microsoft.com/en-us/windows/win32/winmsg/wm-create
	//Ativado quando a função CreateWindowEx ou CreateWindow é chamada
	...
	//Carrega um ícone, cursor, cursor animado ou bitmap.
		hBmp = (HBITMAP)LoadImage(NULL, TEXT("logo.bmp"), IMAGE_BITMAP, 100, 100,
			LR_LOADFROMFILE);
		//BITMAP
		//https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/getobject-function
